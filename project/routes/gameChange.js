    ...
    try {
      ...
      WHERE homeTeam = ${req.body.homeTeam} AND awayTeam=${req.body.awayTeam} AND gameDate='${date}';`
        ...
        await DButils.execQuery(
            `INSERT INTO dbo.Games (gameDate,homeTeam,awayTeam,refereeID,stage) VALUES (
      '${req.body.gameDate}' , ${req.body.homeTeam}, ${req.body.awayTeam},${req.body.refereesID},${req.body.stageID})`
        );
